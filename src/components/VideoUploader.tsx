...
import { Upload, Film, AlertCircle, ArrowLeft } from 'lucide-react';
    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="mt-6">
        <button
          ...
          className="w-full py-4 bg-amber-500 hover:bg-amber-400 disabled:bg-stone-700 disabled:text-stone-500 text-stone-900 disabled:cursor-not-allowed font-semibold rounded-xl transition-all duration-200 hover:shadow-lg hover:shadow-amber-500/20 text-sm"
        >
          Haltung analysieren
        </button>
      </div>
